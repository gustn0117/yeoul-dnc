    ...
    <div className="fixed right-3 sm:right-4 bottom-4 sm:bottom-6 z-40 flex flex-col items-end gap-2 sm:gap-2.5">
      ...
      {showTop && (
        <button
          ...
          className="hover-lift w-10 h-10 sm:w-11 sm:h-11 bg-white text-slate-600 rounded-full shadow-float hover:bg-accent-blue hover:text-white flex items-center justify-center border border-slate-100 animate-fade-in-up transition-colors"
          aria-label="맨 위로"
        >
