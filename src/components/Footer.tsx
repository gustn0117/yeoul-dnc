    ...
    <footer className="bg-[#080e1a]">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-14 lg:py-20">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-10 lg:gap-16">
          ...
          {/* Nav */}
          <div>
            <h4 className="text-[11px] font-bold text-slate-500 uppercase tracking-widest mb-4">메뉴</h4>
          ...
          {/* Contact */}
          <div>
            <h4 className="text-[11px] font-bold text-slate-500 uppercase tracking-widest mb-4">문의</h4>
            <nav className="space-y-2.5">
              <Link href="/contact" className="block text-sm text-slate-500 hover:text-white transition-colors">
                문의하기
              </Link>
        ...
        <div className="mt-14 pt-6 border-t border-white/5 flex flex-col sm:flex-row items-center justify-between gap-3">
          <p className="text-xs text-slate-600">
            &copy; {new Date().getFullYear()} 여울디앤씨. All rights reserved.
          </p>
