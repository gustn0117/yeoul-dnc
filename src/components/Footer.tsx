      ...
      <div className="relative max-w-7xl mx-auto px-5 sm:px-6 lg:px-8 py-12 sm:py-14 lg:py-20">
        ...
        <div className="text-center mb-12 sm:mb-16 pb-12 border-b border-white/5">
          <div className="inline-flex items-center gap-2 px-3 py-1.5 bg-white/5 backdrop-blur-sm rounded-full border border-white/10 mb-5">
            ...
            <span className="text-[12px] font-bold text-slate-300 tracking-wider uppercase">함께 시작해보세요</span>
          </div>
          ...
          <p className="text-[14px] sm:text-sm text-slate-400 max-w-md mx-auto leading-relaxed">
          ...
          <div className="flex flex-wrap justify-center gap-3 mt-6">
            <Link
              href="/contact"
              className="inline-flex items-center gap-2 px-5 py-2.5 bg-linear-to-r from-cta-orange to-orange-500 text-white text-[14px] font-bold rounded-xl shadow-lg shadow-cta-orange/20 hover:shadow-xl transition-shadow"
            >
              무료 상담 받기
            ...
            <a
              href="#"
              className="inline-flex items-center gap-2 px-5 py-2.5 bg-[#FEE500] text-[#3C1E1E] text-[14px] font-bold rounded-xl shadow-lg shadow-amber-900/20 hover:shadow-xl transition-shadow"
            >
        ...
        <div className="grid grid-cols-2 md:grid-cols-12 gap-8 sm:gap-10 lg:gap-12">
          ...
          <div className="col-span-2 md:col-span-5">
            ...
            <p className="text-slate-400 text-[14px] sm:text-sm mb-6 max-w-xs leading-relaxed">
              유입부터 상담 전환까지 설계하는<br />
              <span className="font-semibold text-white">온라인 광고 실행 파트너</span>
            </p>
            <div className="space-y-2 text-[13px] sm:text-[14px] text-slate-500 leading-relaxed">
              ...
              <div className="flex items-start gap-2">
                ...
                <span>사업자등록번호: 880-53-01226</span>
              </div>
              <div className="flex items-start gap-2">
                <svg className="w-3.5 h-3.5 text-accent-blue/60 mt-0.5 shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
          ...
          <div className="md:col-span-3">
            <h4 className="text-[11px] font-extrabold text-accent-blue uppercase tracking-[0.2em] mb-4">메뉴</h4>
            <nav className="space-y-1">
              {[
                ...
                <Link
                  key={item.href}
                  href={item.href}
                  className="group flex items-center justify-between gap-2 py-2 text-[14px] sm:text-sm text-slate-400 hover:text-white border-b border-white/5 last:border-b-0 transition-colors"
                >
          ...
          <div className="md:col-span-4">
            <h4 className="text-[11px] font-extrabold text-accent-blue uppercase tracking-[0.2em] mb-4">운영 채널</h4>
              ...
              {channels.map((c, i) => (
                <div key={c.name} className="group relative" style={{ perspective: "600px" }}>
                  ...
                  >
                    ...
                    />
                    <span
                      className={`relative text-[10px] sm:text-[11px] font-bold tracking-tight ${
            ...
            <Link href="/contact" className="mt-4 inline-flex items-center gap-1.5 text-[13px] font-semibold text-accent-blue hover:text-sky-400 transition-colors">
              빠른 상담 받기
            ...
            >
              ...
              <div className="relative flex items-center gap-4">
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <p className="text-[12px] text-slate-400 mt-0.5">업종과 예산에 맞는 광고 전략을 무료로 제안해드립니다.</p>
                </div>
          ...
          <div className="group relative">
            ...
            >
              ...
              <div className="flex-1 min-w-0">
                ...
                <p className="text-[12px] text-slate-400 mt-0.5">광고 운영부터 성과 분석, 후속 관리까지 정직하고 투명하게 함께합니다.</p>
              </div>
            </div>
          </div>
        </div>
          ...
          >
            <div className="flex items-center gap-3 flex-1 min-w-0">
              ...
              <div className="min-w-0">
                <p className="text-[14px] sm:text-sm font-extrabold text-white">여울디앤씨의 인사이트를 받아보세요</p>
                <p className="text-[11px] sm:text-[12px] text-slate-400 mt-0.5">광고 트렌드와 실무 노하우를 정기적으로 전해드립니다.</p>
              </div>
            </div>
            <div className="flex items-stretch gap-2 w-full sm:w-auto">
              <input
                ...
                className="flex-1 sm:w-56 px-3 py-2 text-[13px] rounded-lg bg-white/5 border border-white/10 text-white placeholder:text-slate-500 focus:border-accent-blue focus:bg-white/[0.07] focus:outline-none transition-colors"
                style={{ boxShadow: "inset 0 1px 2px rgba(0,0,0,0.2)" }}
              />
              <button
                type="button"
                className="relative group/btn px-4 py-2 bg-linear-to-r from-accent-blue to-blue-600 text-white text-[13px] font-bold rounded-lg whitespace-nowrap transition-all duration-300 hover:-translate-y-0.5"
        ...
        <div className="mt-10 sm:mt-12 pt-6 border-t border-white/5 flex flex-col sm:flex-row items-center justify-between gap-3">
          <p className="text-[12px] sm:text-xs text-slate-500 text-center sm:text-left">
            &copy; {new Date().getFullYear()} 여울디앤씨(YEOUL D&amp;C).<br className="sm:hidden" />
            {" "}All rights reserved.
          </p>
          <div className="flex items-center gap-4 sm:gap-5">
            <Link href="#" className="text-[12px] sm:text-xs text-slate-500 hover:text-slate-300 transition-colors">
              개인정보처리방침
            </Link>
            ...
            <span className="w-px h-3 bg-white/10" />
            <Link href="/contact" className="text-[12px] sm:text-xs text-accent-blue hover:text-sky-400 font-semibold transition-colors">
              광고 문의
            </Link>
          </div>
        </div>
