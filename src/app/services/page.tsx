        ...
        <div className="max-w-7xl mx-auto px-5 sm:px-6 lg:px-8">
          <div className="lg:grid lg:grid-cols-2 lg:gap-16 lg:items-center">
            ...
            <div className="relative mb-10 sm:mb-12 lg:mb-0">
              <div className="bg-linear-to-br from-green-50 to-emerald-50/30 rounded-2xl sm:rounded-3xl p-6 sm:p-8 lg:p-12">
                <div className="flex items-center gap-3 mb-4 sm:mb-5">
                  <Logo name="naver" className="h-5 sm:h-6 w-auto" />
              ...
              {/* Floating stat */}
              <div className="absolute -bottom-4 -right-4 bg-white rounded-xl shadow-lg p-3 sm:p-4 border border-slate-100 hidden sm:block lg:block animate-float gradient-border">
                <p className="text-[10px] text-slate-400">검색 전환</p>
                <p className="text-base sm:text-lg font-extrabold text-green-600">높음 <span className="text-xs">↑</span></p>
              </div>
            </div>
            {/* Info */}
            <div>
              <h2 className="text-xl sm:text-2xl lg:text-3xl font-extrabold text-deep-navy mb-3 sm:mb-4">네이버 광고</h2>
              <p className="text-[13px] sm:text-sm text-slate-500 mb-5 sm:mb-6 leading-relaxed">
                한국 사용자의 대부분이 사용하는 포털사이트로,<br className="sm:hidden" />
                {" "}검색하는 순간부터<br className="hidden sm:inline lg:hidden" />
                {" "}고객과 브랜드의 접점을 확보할 수 있습니다.
              </p>
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 mb-5 sm:mb-6">
                <div className="bg-slate-50 rounded-xl p-3.5 sm:p-4">
                ...
                <div className="bg-slate-50 rounded-xl p-3.5 sm:p-4">
                  ...
                  <p className="text-[12px] sm:text-xs text-slate-600 leading-relaxed">병원, 부동산, 서비스업 등 검색 기반 문의 업종</p>
                </div>
              </div>
              <ul className="space-y-2 text-green-700 mb-5 sm:mb-6">
        ...
        <div className="max-w-7xl mx-auto px-5 sm:px-6 lg:px-8">
          <div className="lg:grid lg:grid-cols-2 lg:gap-16 lg:items-center">
            ...
            <div className="order-2 lg:order-1">
              <h2 className="text-xl sm:text-2xl lg:text-3xl font-extrabold text-deep-navy mb-3 sm:mb-4">메타 광고</h2>
              <p className="text-[13px] sm:text-sm text-slate-500 mb-5 sm:mb-6 leading-relaxed">
                Instagram/Facebook 플랫폼에 노출되는<br className="sm:hidden" />
                {" "}맞춤형 광고로,<br className="hidden sm:inline lg:hidden" />
                {" "}타겟의 관심사와 행동 데이터를 기반으로 높은 전환을 유도합니다.
              </p>
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 mb-5 sm:mb-6">
                <div className="bg-white rounded-xl p-3.5 sm:p-4 border border-slate-100">
                  <p className="text-[10px] font-bold text-slate-400 uppercase tracking-wider mb-2">운영 상품</p>
                ...
                <div className="bg-white rounded-xl p-3.5 sm:p-4 border border-slate-100">
                  ...
                  <div className="space-y-1.5 text-[12px] sm:text-xs text-slate-600">
              ...
              <ul className="space-y-2 text-blue-700 mb-5 sm:mb-6">
            ...
            <div className="relative mb-10 sm:mb-12 lg:mb-0 order-1 lg:order-2">
              <div className="bg-linear-to-br from-blue-50 to-indigo-50/30 rounded-2xl sm:rounded-3xl p-6 sm:p-8 lg:p-12">
                <div className="flex items-center gap-2 sm:gap-3 mb-4 sm:mb-5">
                  <Logo name="instagram" className="h-6 sm:h-7 w-auto" />
                  <Logo name="facebook" className="h-6 sm:h-7 w-auto" />
                  <Logo name="meta" className="h-4 sm:h-5 w-auto opacity-40" />
                </div>
                <h3 className="text-base sm:text-lg font-extrabold text-deep-navy mb-3">
                  브랜드 홍보부터<br />매출 증대까지
                </h3>
